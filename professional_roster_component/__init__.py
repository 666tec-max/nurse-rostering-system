...
def professional_roster(nurse_names, date_labels, schedule_data, shift_colors, locked_assignments=None, zoom_level=100, painter_shift=None, key=None):
    """
    Renders a professional interactive roster grid.
    
    Returns: 
        A dict with 'nurse', 'day', 'shift' if an edit occurred, else None.
    """
